...
Smooth line graph displaying the average polarity of headlines over time with the value from 2020 being displayed with a data point. Would like to add labels to points!
...
polarity_over_time %>% 
  ...
  geom_point(aes(x=2020.0, y=0.425), color = "blue", size = 4, label = "Headlines about women") +
  geom_point(aes(x=2020.0, y=0.28), size = 2.5, label = "Headlines about other topics")+
