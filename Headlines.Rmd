...
polarity_site %>% 
  ggplot()+
  geom_point(aes(x=polarity_base, y = fct_reorder(site, polarity_women)), size = 3)+
  geom_point(aes(x=polarity_women, y = fct_reorder(site, polarity_women)), color = "blue", size = 3)+
