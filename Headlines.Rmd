...
pivot_words %>% 
  ...
  labs(title = "The Frequency of Crime and Violence Words")
```
...
word_theme_rank %>% 
  ...
  theme(plot.title = element_text(hjust = 0.5))+
  labs(title = "The Frequency of the Most Common Words in Each Theme",
       y = "",
       x = "") +
      theme(plot.title = element_text(hjust = 0.5),
        panel.grid.minor.x = element_blank(),
...
polarity_site %>% 
  ...
  theme(plot.title = element_text(hjust = 0.5),
        panel.grid.major.x = element_blank(),
        panel.grid.minor.x = element_blank())+
  annotate("text", x = .5, y = 175, label = "Average Polarity of \n Headlines About Women", color = "mediumpurple2")+
  annotate("text", x = .5, y = 173, label = "Average Polarity of \n General Headlines")+
  labs(title = "Differences in Site Polarity: Headlines about Women vs General Headlines")
```
